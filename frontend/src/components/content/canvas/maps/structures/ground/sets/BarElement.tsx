...
import { Doll_Chick } from '../elements/Doll_Chick';
...
export function BarElement() {
    return (
        <>
            ...
            />
            <Frame_2
                position={[24.55, 1.5, 4]}
                rotation={[Math.PI / 2, 0, -Math.PI / 1]}
            />
            <Frame_3
                position={[20.55, 1.5, 4]}
                rotation={[Math.PI / 2, 0, -Math.PI / 1]}
            />
            <Frame_5
                position={[17.55, 1.5, 4]}
                rotation={[Math.PI / 2, 0, -Math.PI / 1]}
            />
            <Frame_6
                position={[14.55, 1.5, 4]}
                rotation={[Math.PI / 2, 0, -Math.PI / 1]}
            />
            <Window_8
                position={[5.55, 4, 4]}
            ...
            <Sandwich_1
                ...
                rotation={[Math.PI / 2, 0, 0]}
            />
            <Sausages_1 position={[0, 2.25, -3]} rotation={[0, 0, 0]} />
            <Plate_1
            ...
            {/* 회의실 */}
            <Vase_1 position={[-28, 0.75, 37]} rotation={[Math.PI / 2, 0, 0]} />
            <Vase_1 position={[-28, 0.75, 82]} rotation={[Math.PI / 2, 0, 0]} />
            <Vase_1 position={[-53, 0.75, 82]} rotation={[Math.PI / 2, 0, 0]} />
            <Drawer_pink_1
                position={[-28, 1.3, 54]}
                rotation={[Math.PI / 2, 0, Math.PI / 2]}
            />
            <Drawer_pink_1
                position={[-28, 1.3, 57.2]}
                rotation={[Math.PI / 2, 0, Math.PI / 2]}
            />
            <Drawer_pink_1
                position={[-28, 1.3, 60.4]}
                rotation={[Math.PI / 2, 0, Math.PI / 2]}
            />
            <Book_4
                position={[-28, 3, 53.2]}
            ...
            <Book_1 position={[-52, 1, -30]} rotation={[Math.PI / 2, 0, 0]} />
            <Book_2 position={[-50, 1, -32]} rotation={[Math.PI / 2, 0, 0]} />

            <Book_3 position={[-49, 1, -31]} rotation={[Math.PI / 2, 0, 0]} />
            <Book_4 position={[-51, 1, -29]} rotation={[Math.PI / 2, 0, 0]} />
            <Book_5 position={[-53, 1, -31]} rotation={[Math.PI / 2, 0, 0]} />
            ...
            <Sandwich_1
                ...
                rotation={[Math.PI / 2, 0, 0]}
            />
            <Fork position={[-52, 2.1, 11]} rotation={[0, Math.PI / 3, 0]} />
            <Cup_1
                position={[-52.6, 2.3, 9]}
                rotation={[Math.PI / 2, 0, -Math.PI / 3]}
            />
            <Plate_1
                position={[-52.6, 2.3, 12]}
                rotation={[Math.PI / 2, 0, -Math.PI / 3]}
            />
            ...
            <RoundTable_orange
                ...
                rotation={[Math.PI / 2, 0, 0]}
            />
            <Flower_8 position={[-37, 2.1, 0]} rotation={[Math.PI / 2, 0, 0]} />
            <Mirror_1
                position={[-36, 3, 3]}
                rotation={[Math.PI / 2, 0, Math.PI / 2]}
            />
            ...
            <Lamp_1 position={[5, 2.2, 7]} rotation={[Math.PI / 2, 0, 0]} />
            <Lamp_2 position={[-5, 2.2, 7]} rotation={[Math.PI / 2, 0, 0]} />
