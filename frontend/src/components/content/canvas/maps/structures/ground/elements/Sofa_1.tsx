...
Command: npx gltfjsx@6.2.16 public/models/object/Sofa_1.glb -t -o src/components/content/canvas/maps/structures/ground/elements/Sofa_1.tsx 
*/
...
function Sofa_1Component(props: ObjectSettingType) {
    ...
    return (
        <group position={[0, 0.2, 0]} dispose={null}>
            <mesh
                ref={ref}
                geometry={nodes.Couch_5.geometry}
