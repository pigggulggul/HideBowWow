    ...
    return (
        <group position={[0, 0, 0]} dispose={null}>
            <group>
                <mesh
                    ref={ref}
                    geometry={nodes.Pig_Black_0.geometry}
                ...
                <mesh
                    ref={ref}
                    geometry={nodes.Pig_Light_Pink_0.geometry}
                ...
                <mesh
                    ref={ref}
                    geometry={nodes.Pig_Pink_0.geometry}
...
export const Pig = React.memo(PigComponent, areEqual);
