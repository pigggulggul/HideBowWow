...
export function Bush_4(props: ObjectSettingType) {
  const { nodes, materials } = useGLTF('/models/object/Bush_4.glb') as GLTFResult
  ...
  return (
    <group position={[0, 0, 0]} dispose={null}>
      <group>
        <mesh ref={ref} geometry={nodes.Bush004_Forest_Green_0.geometry} material={materials.Forest_Green} position={props.position} rotation={props.rotation}/>
        <mesh ref={ref} geometry={nodes.Bush004_Grass_Green_0.geometry} material={materials.Grass_Green} position={props.position} rotation={props.rotation}/>
      </group>
    </group>
  )
}
