...
function House_2Component(props: ObjectSettingType) {
    const { nodes, materials } = useGLTF(
        '/models/object/House_2.glb'
    ) as GLTFResult;
    ...
    return (
        <group position={[0, 0, 0]} dispose={null}>
            <group>
                <mesh
                    ref={ref}
                    geometry={nodes.House_2_Black_0.geometry}
                ...
                <mesh
                    ref={ref}
                    geometry={nodes.House_2_Brown__0.geometry}
                ...
                <mesh
                    ref={ref}
                    geometry={nodes.House_2_Dark_Blue__0.geometry}
                ...
                <mesh
                    ref={ref}
                    geometry={nodes.House_2_Gray_Blue__0.geometry}
                    material={materials.Gray_Blue_12}
                    position={props.position}
                    rotation={props.rotation}
                />
                <mesh
                    ref={ref}
                    geometry={nodes.House_2_Gray_0.geometry}
                ...
                <mesh
                    ref={ref}
                    geometry={nodes.House_2_Light_Gray_0.geometry}
                ...
                <mesh
                    ref={ref}
                    geometry={nodes.House_2_Purple_2_0.geometry}
                    material={materials.Purple_2}
                    position={props.position}
                    rotation={props.rotation}
                />
                <mesh
                    ref={ref}
                    geometry={nodes.House_2_Purple_3_0.geometry}
                    material={materials.Purple_3}
                    position={props.position}
                    rotation={props.rotation}
                />
                <mesh
                    ref={ref}
                    geometry={nodes.House_2_Purple_4_0.geometry}
                    material={materials.Purple_4}
                    position={props.position}
                    rotation={props.rotation}
                />
            </group>
