...
Command: npx gltfjsx@6.2.16 public/models/object/Window_8.glb -t -o src/components/content/canvas/maps/structures/ground/elements/Window_8.tsx 
*/
...
function Window_8Component(props: ObjectSettingType) {
    const { nodes, materials } = useGLTF(
        '/models/object/Window_8.glb'
    ) as GLTFResult;
...
useGLTF.preload('/models/object/Window_8.glb');
