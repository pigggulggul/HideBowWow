...
export function Tree_4(props: ObjectSettingType) {
  const { nodes, materials } = useGLTF('/models/object/Tree_4.glb') as GLTFResult
  ...
  return (
    <group position={[0, 0, 0]} dispose={null}>
      <group >
        <mesh ref={ref} geometry={nodes.Tree_4_Brown_2_0.geometry} material={materials.Brown_2} position={props.position} rotation={props.rotation} />
        <mesh ref={ref} geometry={nodes.Tree_4_Grass_Green_0.geometry} material={materials.Grass_Green} position={props.position} rotation={props.rotation} />
      </group>
    </group>
  )
}
