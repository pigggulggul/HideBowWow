    ...
    return (
        <group position={[0, 0, 0]} dispose={null}>
            <group>
                <mesh
                    ref={ref}
                    geometry={nodes.Tree_5_Brown_2_0.geometry}
                ...
                <mesh
                    ref={ref}
                    geometry={nodes.Tree_5_Dark_Gray_0.geometry}
                ...
                <mesh
                    ref={ref}
                    geometry={nodes.Tree_5_Forest_Green_0.geometry}
...
export default React.memo(Tree_5Component, areEqual);