...
export function Dumpster(props: ObjectSettingType) {
  const { nodes, materials } = useGLTF('/models/object/Dumpster.glb') as GLTFResult
  ...
  return (
    <group  position={[0, 0, 0]} dispose={null}>
      <group >position={props.position} rotation={props.rotation}
        <mesh ref={ref} geometry={nodes.Dumpster_Dark_Gray_0.geometry} material={materials.Dark_Gray} position={props.position} rotation={props.rotation}/>
        <mesh ref={ref} geometry={nodes.Dumpster_Forest_Green_0.geometry} material={materials.Forest_Green} position={props.position} rotation={props.rotation}/>
      </group>
    </group>
  )
}
