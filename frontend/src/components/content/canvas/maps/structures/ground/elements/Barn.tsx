...
export function Barn(props: ObjectSettingType) {
  ...
  return (
    <group  position={[0, 0, 0]} dispose={null}>
      <group>
        <mesh ref={ref} geometry={nodes.Barn_Dark_Gray_0.geometry} material={materials.Dark_Gray} position={props.position} rotation={props.rotation}/>
        <mesh ref={ref} geometry={nodes.Barn_Light_Gray_0.geometry} material={materials.Light_Gray} position={props.position} rotation={props.rotation}/>
        <mesh ref={ref} geometry={nodes.Barn_Red_0.geometry} material={materials.material} position={props.position} rotation={props.rotation}/>
      </group>
    </group>
  )
}
