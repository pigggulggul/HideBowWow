...
export function Bench_2(props: ObjectSettingType) {
  const { nodes, materials } = useGLTF('/models/object/Bench_2.glb') as GLTFResult
  ...
  return (
    <group position={[0, 0, 0]} dispose={null}>
      <group>
        <mesh ref={ref}  geometry={nodes.Bench_2_Brown_3_0.geometry} material={materials.Brown_3} position={props.position} rotation={props.rotation}/>
        <mesh ref={ref}  geometry={nodes.Bench_2_Gray_0.geometry} material={materials.Gray} position={props.position} rotation={props.rotation}/>
      </group>
    </group>
  )
}
