...
function Grave_1Component(props: ObjectSettingType) {
    const { nodes, materials } = useGLTF(
        '/models/object/Grave_1.glb'
    ) as GLTFResult;
    ...
    return (
        <group position={[0, 0, 0]} dispose={null}>
            <group>
                <mesh
                    ref={ref}
                    geometry={nodes.Grave_1_Brown_2_0.geometry}
                ...
                <mesh
                    ref={ref}
                    geometry={nodes.Grave_1_Gray_Blue_0.geometry}
                ...
                <mesh
                    ref={ref}
                    geometry={nodes.Grave_1_Light_Gray_0.geometry}
